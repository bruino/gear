...
def index():
    ...
    grid = SQLFORM.smartgrid(db.Provision,
                             fields=fields,
                             create=True,
                             deletable=True,
                             editable=True,
...
@auth.requires_login()
def admin():
    grid_user = SQLFORM.smartgrid(db.auth_user, breadcrumbs_class='breadcrumb',)
    grid_registro = SQLFORM.smartgrid(db.Registro, breadcrumbs_class='breadcrumb',)
    grid_provision = SQLFORM.smartgrid(db.Provision, breadcrumbs_class='breadcrumb',)
    return locals()
